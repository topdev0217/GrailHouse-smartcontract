...
contract GrailHouse is Ownable, ERC721A, ReentrancyGuard {    
    uint256 constant MAX_ELEMENTS = 888;     
    uint256 constant PUBLIC_PRICE = 0.04 ether;
    uint256 constant MAX_ELEMENTS_ONE_TIME = 8;
    ...
    constructor() ERC721A("SoulDrops", "SOULDROPS", MAX_ELEMENTS_ONE_TIME) {}
    ...
    function publicMint(uint256 numberOfTokens) external payable nonReentrant {
        ...
        require(numberOfTokens > 0, 'You can purchase over 1.');
